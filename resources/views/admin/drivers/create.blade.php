...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-6">
        <div>
            <h4 class="mb-0">Tambah Driver</h4>
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="driver_code" value="{{ old('driver_code') }}" class="form-control @error('driver_code') is-invalid @enderror" required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="license_type" value="{{ old('license_type') }}" class="form-control @error('license_type') is-invalid @enderror">
            ...
            <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mb-4">
                            <div class="position-relative d-inline-block">
                                <img id="photoPreview" src="https://ui-avatars.com/api/?name=Driver&background=0d6efd&color=fff&size=128" alt="Preview" class="rounded-circle object-fit-cover border" width="120" height="120" />
                ...
                <div class="card card-lg">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100 mb-2"><i class="ti ti-check me-1"></i> Simpan Driver</button>
