        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="vehicle_code" value="{{ old('vehicle_code') }}" class="form-control @error('vehicle_code') is-invalid @enderror" required>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="vehicle_type" value="{{ old('vehicle_type') }}" class="form-control @error('vehicle_type') is-invalid @enderror" required>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="number" name="year" value="{{ old('year') }}" maxlength="4" class="form-control @error('year') is-invalid @enderror">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Kapasitas</label>
                                <input type="number" name="capacity" value="{{ old('capacity') }}" class="form-control @error('capacity') is-invalid @enderror">
                            </div>
                            <div class="col-md-4">
            ...
            <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mb-4">
                            <div class="position-relative d-inline-block">
                                <img id="photoPreview" src="https://ui-avatars.com/api/?name=Vehicle&background=0d6efd&color=fff&size=128" alt="Preview" class="rounded-circle object-fit-cover border" width="120" height="120" />
                ...
                <div class="card card-lg">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100 mb-2"><i class="ti ti-check me-1"></i> Simpan Kendaraan</button>
