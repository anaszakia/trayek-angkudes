        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="schedule_code" value="{{ old('schedule_code') }}" class="form-control @error('schedule_code') is-invalid @enderror" required>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="day_of_week" value="{{ old('day_of_week') }}" class="form-control @error('day_of_week') is-invalid @enderror" placeholder="Contoh: Monday" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="time" step="1" name="departure_time" value="{{ old('departure_time') }}" class="form-control @error('departure_time') is-invalid @enderror" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="time" step="1" name="arrival_time" value="{{ old('arrival_time') }}" class="form-control @error('arrival_time') is-invalid @enderror" required>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="number" min="1" name="frequency_minutes" value="{{ old('frequency_minutes') }}" class="form-control @error('frequency_minutes') is-invalid @enderror">
            ...
            <div class="col-xl-4">
                <div class="card card-lg">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100 mb-2"><i class="ti ti-check me-1"></i> Simpan Jadwal</button>
