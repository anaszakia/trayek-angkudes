...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-6">
        <div>
            <h4 class="mb-0">Tambah Trayek</h4>
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                ...
                                <select name="route_type" class="form-select @error('route_type') is-invalid @enderror" required>
                                    <option value="one_way" {{ old('route_type') == 'one_way' ? 'selected' : '' }}>One Way</option>
                                    <option value="round_trip" {{ old('route_type') == 'round_trip' ? 'selected' : '' }}>Round Trip</option>
                                    <option value="loop" {{ old('route_type') == 'loop' ? 'selected' : '' }}>Loop</option>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" name="distance_km" value="{{ old('distance_km') }}" class="form-control @error('distance_km') is-invalid @enderror">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="start_point" value="{{ old('start_point') }}" class="form-control @error('start_point') is-invalid @enderror" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="end_point" value="{{ old('end_point') }}" class="form-control @error('end_point') is-invalid @enderror" required>
            ...
            <div class="col-xl-4">
                <div class="card card-lg">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100 mb-2"><i class="ti ti-check me-1"></i> Simpan Trayek</button>
